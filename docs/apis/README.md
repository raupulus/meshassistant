...
(ver [flujo y límites](../../apis/aemet/00-fundamentos.md#flujo-de-dos-pasos)).
```
...
Para **llevar este directorio a otro proyecto**, usa el prompt de
**[_PROMPT-IMPORTAR-EN-OTRO-PROYECTO.md](_PROMPT-IMPORTAR-EN-OTRO-PROYECTO.md)**: registra
`docs/apis/` en las instrucciones del proyecto destino y le da el contexto crítico de la API sin
que tenga que leerse todo.
